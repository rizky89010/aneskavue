...
import HeaderAneska from '@/components/HeaderAneska.vue';
import footeraneska from '@/components/footeraneska.vue';
import relatedAneska from '@/components/relatedAneska.vue';
